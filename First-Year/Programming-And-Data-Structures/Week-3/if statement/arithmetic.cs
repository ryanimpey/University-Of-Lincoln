...
class arithmetic{
	static void Main( string[] args){
		...
		Console.WriteLine("\n{0} and {1} average = {2}.", number1, number2, average); //Write average to console
	
		//If statement
		if(number1 > number2){
			Console.WriteLine("{0} is greater than {1}", nameof(number1), nameof(number2)); //Number1 is greater
		} else if(number1 < number2){
			Console.WriteLine("{0} is greater than {1}", nameof(number2), nameof(number1)); //Number2 is greater
		} else{
			Console.WriteLine("{0} and {1} are the same value!", nameof(number1), nameof(number2)); //Numbers are same value
		};
